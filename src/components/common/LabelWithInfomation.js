...
export default function LabelWithInfomation({ information, searchType }) {
    ...
    return (
        <Fragment>
            <label className="block mb-2 text-base font-medium">
                ...
                <button className="ml-2 text-gray-500 cursor-pointer inline-block align-sub" onClick={() => setShowPopup(true)}>
            ...
            {showPopup && (
                <div className="fixed bg-white border p-4 rounded shadow-lg mt-2 left-1/4 right-1/4">
                    <button className="absolute top-0 right-0 p-2" onClick={() => setShowPopup(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">

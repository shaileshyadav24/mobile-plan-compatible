            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {
                    loadingItems.map(plan => {
                        return (
                            <div key={plan.id} className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                                <h3 className="mb-4 text-2xl font-semibold w-60 h-4 bg-gray-200 rounded-full"></h3>
                                <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400 w-60 h-4 bg-gray-200 rounded-full"></p>
